...
| `VAKT_UPLOAD_DIR` | — | `/data/uploads` | Verzeichnis für hochgeladene Dateien (Evidence-Anhänge). Im Docker-Compose-Stack als Volume `uploads_data` gemountet — nicht als Host-Pfad ändern. |
