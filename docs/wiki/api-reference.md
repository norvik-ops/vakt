...
Training assignment and completion tracking are available in Community. The phishing-campaign, template and target-group endpoints below require **Pro** (`vaktaware_advanced`, `features.FeatureSecReflex`).
