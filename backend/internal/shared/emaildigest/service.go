...
// euAIActDisclaimer returns the EU AI Act Art. 52 transparency disclaimer in the
// given language. Art. 52 requires that users are informed when they interact
// with AI-generated content so they can make informed decisions.
func euAIActDisclaimer(lang string) string {
	switch lang {
	case "en":
		return "⚠ This content was generated by an AI system (EU AI Act Art. 52). Please verify with a qualified expert before acting on it."
	case "fr":
		return "⚠ Ce contenu a été généré par un système d'IA (Règlement IA UE Art. 52). Veuillez le vérifier auprès d'un expert qualifié avant d'agir."
	case "nl":
		return "⚠ Deze inhoud is gegenereerd door een AI-systeem (EU AI Act Art. 52). Verifieer dit bij een gekwalificeerde expert voordat u actie onderneemt."
	default: // "de"
		return "⚠ Dieser Inhalt wurde von einem KI-System generiert (EU-KI-Verordnung Art. 52). Bitte lassen Sie ihn von einem qualifizierten Experten prüfen, bevor Sie darauf basierend handeln."
	}
}
...
// Includes EU AI Act Art. 52 transparency disclaimer as required for AI-generated content.
func buildAIDigestBody(narrative, orgName string) string {
	...
	buf.WriteString(`<hr style="margin-top:24px;"/>`)
	// EU AI Act Art. 52 transparency notice — required for all AI-generated output channels.
	fmt.Fprintf(&buf, `<p style="font-size:0.8em;color:#c05621;border-left:3px solid #c05621;padding-left:8px;margin-top:12px;">%s</p>`,
		html.EscapeString(euAIActDisclaimer("de")))
	buf.WriteString(`<p style="font-size:0.75em;color:#a0aec0;">`)
