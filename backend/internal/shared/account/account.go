...
func (h *Handler) DeleteAccount(c echo.Context) error {
	...
	case nil:
		...
		c.SetCookie(&http.Cookie{Name: "access_token", Value: "", Path: "/api/v1", MaxAge: -1}) // nosemgrep -- deletion cookie, MaxAge:-1; browser ignores Secure/HttpOnly on expired cookies
		c.SetCookie(&http.Cookie{Name: "csrf_token", Value: "", Path: "/api/v1", MaxAge: -1})   // nosemgrep -- deletion cookie, MaxAge:-1; browser ignores Secure/HttpOnly on expired cookies
