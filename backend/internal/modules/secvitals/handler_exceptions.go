...
// ListControlExceptions handles GET /api/v1/secvitals/exceptions[?control_id=:id]
...
// CreateControlException handles POST /api/v1/secvitals/controls/:controlId/exceptions
...
// UpdateControlException handles PUT /api/v1/secvitals/exceptions/:id
...
// DeleteControlException handles DELETE /api/v1/secvitals/exceptions/:id
