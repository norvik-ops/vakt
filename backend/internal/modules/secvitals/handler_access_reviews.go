...
// ListAccessReviewCampaigns handles GET /api/v1/secvitals/access-reviews.
...
// CreateAccessReviewCampaign handles POST /api/v1/secvitals/access-reviews.
...
// GetAccessReviewCampaign handles GET /api/v1/secvitals/access-reviews/:id.
...
// UpdateAccessReviewCampaign handles PUT /api/v1/secvitals/access-reviews/:id.
...
// DeleteAccessReviewCampaign handles DELETE /api/v1/secvitals/access-reviews/:id.
...
// ListAccessReviewItems handles GET /api/v1/secvitals/access-reviews/:id/items.
...
// CreateAccessReviewItem handles POST /api/v1/secvitals/access-reviews/:id/items.
...
// UpdateAccessReviewItem handles PUT /api/v1/secvitals/access-reviews/:id/items/:itemId.
