// Package secprivacy provides HTTP handlers for the DSGVO documentation module.
package secprivacy
...
// ListVVT handles GET /api/v1/secprivacy/vvt.
...
// GetVVT handles GET /api/v1/secprivacy/vvt/:id.
...
// CreateVVT handles POST /api/v1/secprivacy/vvt.
...
// UpdateVVT handles PUT /api/v1/secprivacy/vvt/:id.
...
// DeleteVVT handles DELETE /api/v1/secprivacy/vvt/:id.
...
// ListDPIAs handles GET /api/v1/secprivacy/dpias.
...
// GetDPIA handles GET /api/v1/secprivacy/dpias/:id.
...
// CreateDPIA handles POST /api/v1/secprivacy/dpias.
...
// UpdateDPIA handles PUT /api/v1/secprivacy/dpias/:id.
...
// ApproveDPIA handles POST /api/v1/secprivacy/dpias/:id/approve.
...
// DeleteDPIA handles DELETE /api/v1/secprivacy/dpias/:id.
...
// ListAVVs handles GET /api/v1/secprivacy/avvs.
...
// GetAVV handles GET /api/v1/secprivacy/avvs/:id.
...
// CreateAVV handles POST /api/v1/secprivacy/avvs.
...
// UpdateAVV handles PUT /api/v1/secprivacy/avvs/:id.
...
// DeleteAVV handles DELETE /api/v1/secprivacy/avvs/:id.
...
// ListBreaches handles GET /api/v1/secprivacy/breaches.
...
// GetBreach handles GET /api/v1/secprivacy/breaches/:id.
...
// CreateBreach handles POST /api/v1/secprivacy/breaches.
...
// UpdateBreach handles PUT /api/v1/secprivacy/breaches/:id.
...
// DeleteBreach handles DELETE /api/v1/secprivacy/breaches/:id.
...
// MarkAuthorityNotified handles POST /api/v1/secprivacy/breaches/:id/notify-authority.
...
// ExportVVT handles GET /api/v1/secprivacy/vvt/export.
...
// ExportDPIA handles GET /api/v1/secprivacy/dpias/export.
...
// CreateDSR handles POST /api/v1/secprivacy/dsr.
...
// UpdateDSR handles PUT /api/v1/secprivacy/dsr/:id.
...
// DeleteDSR handles DELETE /api/v1/secprivacy/dsr/:id.
...
// ExportDSRsCSV handles GET /api/v1/secprivacy/dsrs/export.csv.
...
// ExportBreachNotification handles GET /api/v1/secprivacy/breaches/:id/notification-pdf.
...
// GetDSRPortalSettings handles GET /api/v1/secprivacy/dsr-portal-settings.
...
// UpdateDSRPortalSettings handles PATCH /api/v1/secprivacy/dsr-portal-settings.
...
// ExportAVVPDF handles GET /api/v1/secprivacy/avvs/:id/pdf.
...
// UpdateAVVSCC handles PATCH /api/v1/secprivacy/avvs/:id/scc.
...
// ExportSCCPDF handles GET /api/v1/secprivacy/avvs/:id/scc.pdf.
