...
// GetPolicy handles GET /api/v1/vaktcomply/policies/:id.
func (h *Handler) GetPolicy(c echo.Context) error {
	id := c.Param("id")
	policy, err := h.service.Policy.GetPolicy(c.Request().Context(), orgID(c), id)
	if err != nil {
...
func (h *Handler) UpdatePolicy(c echo.Context) error {
	...
	policy, err := h.service.Policy.UpdatePolicy(c.Request().Context(), orgID(c), id, in)
	if err != nil {
...
func (h *Handler) CreatePolicy(c echo.Context) error {
	...
	policy, err := h.service.Policy.CreatePolicy(c.Request().Context(), orgID(c), in)
	if err != nil {
...
func (h *Handler) ListPolicyVersions(c echo.Context) error {
	policyID := c.Param("id")
	versions, err := h.service.Policy.ListPolicyVersions(c.Request().Context(), orgID(c), policyID)
	if err != nil {
...
func (h *Handler) GetPolicyVersion(c echo.Context) error {
	...
	pv, err := h.service.Policy.GetPolicyVersion(c.Request().Context(), orgID(c), policyID, vNum)
	if err != nil {
...
func (h *Handler) CreatePolicyFromTemplate(c echo.Context) error {
	...
	policy, err := h.service.Policy.CreatePolicy(c.Request().Context(), orgID, in)
	if err != nil {
...
func (h *Handler) GeneratePolicyDraft(c echo.Context) error {
	...
	draft, err := h.service.Policy.GeneratePolicyDraft(c.Request().Context(), orgID(c), in)
	if err != nil {
