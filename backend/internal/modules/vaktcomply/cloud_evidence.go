...
// CloudEvidenceWriter adapts vaktcomply.Repository to implement cloud.EvidenceWriter.
// This keeps the shared/integrations/cloud package free of any vaktcomply import.
