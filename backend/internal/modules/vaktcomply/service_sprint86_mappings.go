...
var der4CrossMappings = []struct {
	...
	{"BSI", "BSI-DER.4.A4", "ISO27001", "A.8.13", "related"},    // BIA → Backup-Informationen
	{"BSI", "BSI-DER.4.A5", "ISO27001", "A.5.29", "equivalent"}, // Notfallkonzept = Umsetzung
	{"BSI", "BSI-DER.4.A5", "ISO27001", "A.8.14", "related"},    // WAP → Redundanz IT
	{"BSI", "BSI-DER.4.A6", "ISO27001", "A.5.30", "equivalent"}, // Übungen = ICT readiness for BC
	{"BSI", "BSI-DER.4.A8", "ISO27001", "A.5.29", "related"},    // Alarmierungsplan
	...
	{"BSI", "BSI-DER.4.A5", "NIS2", "NIS2-C.1", "related"},

	// DER.4 ↔ DORA (Finanzsektor)
	{"BSI", "BSI-DER.4.A5", "DORA", "DORA-S.3", "related"}, // ICT Recovery Plans
	{"BSI", "BSI-DER.4.A6", "DORA", "DORA-S.4", "related"}, // Testing
}
