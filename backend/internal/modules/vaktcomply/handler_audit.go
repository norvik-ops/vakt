...
func (h *Handler) CreateAuditPlan(c echo.Context) error {
	var in auditmod.CreateAuditPlanInput
	if err := c.Bind(&in); err != nil {
		return errResp(c, http.StatusBadRequest, "invalid request body", "CK_BAD_REQUEST")
	}
	if err := h.validate.Struct(in); err != nil {
...
func (h *Handler) CreateAuditProgramAudit(c echo.Context) error {
	var in auditmod.CreateAuditProgramAuditInput
	if err := c.Bind(&in); err != nil {
		return errResp(c, http.StatusBadRequest, "invalid request body", "CK_BAD_REQUEST")
	}
	if err := h.validate.Struct(in); err != nil {
...
func (h *Handler) CompleteAuditProgramAudit(c echo.Context) error {
	var in auditmod.CompleteAuditInput
	if err := c.Bind(&in); err != nil {
		return errResp(c, http.StatusBadRequest, "invalid request body", "CK_BAD_REQUEST")
	}
	if err := h.validate.Struct(in); err != nil {
...
func (h *Handler) CreateAuditFinding(c echo.Context) error {
	var in auditmod.CreateAuditFindingInput
	if err := c.Bind(&in); err != nil {
		return errResp(c, http.StatusBadRequest, "invalid request body", "CK_BAD_REQUEST")
	}
	if err := h.validate.Struct(in); err != nil {
...
func (h *Handler) ListManagementReviews(c echo.Context) error {
	reviews, err := h.service.Audit.ListManagementReviews(c.Request().Context(), orgID(c))
	if err != nil {
	...
	if reviews == nil {
		reviews = []auditmod.ManagementReview{}
	}
...
func (h *Handler) CreateManagementReview(c echo.Context) error {
	var in auditmod.CreateManagementReviewInput
	if err := c.Bind(&in); err != nil {
		return errResp(c, http.StatusBadRequest, "invalid request body", "CK_BAD_REQUEST")
	}
	...
	review, err := h.service.Audit.CreateManagementReview(c.Request().Context(), orgID(c), userID(c), in)
	if err != nil {
...
func (h *Handler) GetManagementReview(c echo.Context) error {
	id := c.Param("id")
	review, err := h.service.Audit.GetManagementReview(c.Request().Context(), orgID(c), id)
	if err != nil {
...
func (h *Handler) UpdateManagementReviewInputs(c echo.Context) error {
	id := c.Param("id")
	var in auditmod.UpdateManagementReviewInputsInput
	if err := c.Bind(&in); err != nil {
		return errResp(c, http.StatusBadRequest, "invalid request body", "CK_BAD_REQUEST")
	}
	review, err := h.service.Audit.UpdateManagementReviewInputs(c.Request().Context(), orgID(c), id, in)
	if err != nil {
		if isNotFound(err) {
			return errResp(c, http.StatusNotFound, "management review not found", "CK_MGMT_REVIEW_NOT_FOUND")
		}
...
func (h *Handler) UpdateManagementReviewOutputs(c echo.Context) error {
	id := c.Param("id")
	var in auditmod.UpdateManagementReviewOutputsInput
	if err := c.Bind(&in); err != nil {
		return errResp(c, http.StatusBadRequest, "invalid request body", "CK_BAD_REQUEST")
	}
	review, err := h.service.Audit.UpdateManagementReviewOutputs(c.Request().Context(), orgID(c), id, in)
	if err != nil {
		if isNotFound(err) {
			return errResp(c, http.StatusNotFound, "management review not found", "CK_MGMT_REVIEW_NOT_FOUND")
		}
...
func (h *Handler) CreateAuditorLink(c echo.Context) error {
	...
	return c.JSON(http.StatusCreated, map[string]string{
		"auditor_url": "/api/v1/vaktcomply/auditor/" + rawToken,
	})
}

// AuditorView handles GET /api/v1/vaktcomply/auditor/:token — no auth required.
...
// ListAuditorLinks handles GET /api/v1/vaktcomply/auditor-links.
...
// RevokeAuditorLink handles DELETE /api/v1/vaktcomply/auditor-links/:id.
...
// AuditorExportBundle handles GET /api/v1/vaktcomply/auditor/:token/export — no auth required.
...
// AuditorExportZIP handles GET /auditor/vaktcomply/export.zip.
...
// CreateMilestone handles POST /api/v1/vaktcomply/milestones
...
// UpdateMilestone handles PUT /api/v1/vaktcomply/milestones/:id
...
// DeleteMilestone handles DELETE /api/v1/vaktcomply/milestones/:id
...
// GetNextMilestone handles GET /api/v1/vaktcomply/milestones/next
