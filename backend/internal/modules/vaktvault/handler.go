...
func (h *Handler) GetSecret(c echo.Context) error {
	...
	safego.Run(c.Request().Context(), "vaktvault.secret.reveal.audit", func(parent context.Context) error {
		if auditOrgID == "" {
			return nil
		}
...
// GetProjectAccessLog handles GET /vaktvault/projects/:project_id/access-log.
...
// ImportSecrets handles POST /vaktvault/projects/:project_id/import
...
// ExportSecrets handles GET /vaktvault/projects/:project_id/envs/:env_id/export
...
// RotateSecret handles POST /vaktvault/projects/:project_id/envs/:env_id/secrets/:key/rotate
...
// TriggerGitScan handles POST /vaktvault/git-scans
...
// ListGitScans handles GET /vaktvault/git-scans
...
// GetGitScan handles GET /vaktvault/git-scans/:id
...
// GetGitScanResults handles GET /vaktvault/git-scans/:id/results
...
// DismissScanResult handles POST /vaktvault/git-scans/results/:result_id/dismiss
