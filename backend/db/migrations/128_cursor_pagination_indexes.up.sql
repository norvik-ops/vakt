...
-- vaktscan findings (table is vb_findings)
...
-- vaktcomply controls (ordered by control_id ASC for keyset)
...
-- vaktprivacy DSRs (table is po_dsr)
...
-- vaktaware campaigns (table is sr_campaigns)
